      ...
      React.createElement("div", {className: "container-fluid header"}, 
        React.createElement("div", {className: "row"}, 
          ...
          React.createElement("div", {className: "col-md-3"}, 
            React.createElement("p", {className: "header-title"}, /* <strong>{hostel.price}<span className="currency">{hostel.currency}</span></strong> */hostel.url != null ? React.createElement("span", {className: "book-span"}, React.createElement("a", {href: hostel.url, target: "_blank", className: "book-link"}, "Book")) : "")
          )
        )
      )
    );
