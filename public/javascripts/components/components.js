				...
				React.createElement("div", {className: "container-fluid"}, 
					...
					React.createElement("div", {className: "collapse navbar-collapse", id: "bs-example-navbar-collapse-1"}, 
						React.createElement("ul", {className: "nav navbar-nav navbar-right"}, 
							...
							React.createElement("li", null, React.createElement("a", {className: "a-addthis", href: "#"}, React.createElement("div", {className: "addthis_sharing_toolbox addthis_top"})))
						)
					)
				)
			)
...
var TripTailorAutoCompleteTags = React.createClass({displayName: "TripTailorAutoCompleteTags",
	...
	render: function() {
		var tags = $.map(this.props.tags, function(value, i) {
			return (
				React.createElement(TripTailorInputTag, {key: i, index: i, value: value, removeSpecificTag: this.props.removeSpecificTag})
			);
		}.bind(this));

		return (
			React.createElement("div", {className: "autocomplete-tags-container"}, 
...
var TripTailorInputTag = React.createClass({displayName: "TripTailorInputTag",
	...
	render: function() {
		return (
			React.createElement("div", {className: "input-tag"}, this.props.value, React.createElement("span", {className: "close-tag", onClick: this.remove}, React.createElement("strong", null, "x")))
		);
	}
});
